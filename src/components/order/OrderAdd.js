                                                ...
                                                <div className="col-2 d-flex align-items-center">
                                                    {item.id && (
                                                        <img
                                                            src={
                                                                item.type === 'product'
                                                                    ? (products.find(p => String(p.id) === String(item.id))?.image_url
                                                                        ? process.env.REACT_APP_API_URL + 'api/images/' + products.find(p => String(p.id) === String(item.id)).image_url
                                                                        : '/no-image.png')
                                                                    : (combos.find(c => String(c.id) === String(item.id))?.image_url
                                                                        ? process.env.REACT_APP_API_URL + 'api/images/' + combos.find(c => String(c.id) === String(item.id)).image_url
                                                                        : '/no-image.png')
                                                            }
                                                            alt=""
                                                            style={{
