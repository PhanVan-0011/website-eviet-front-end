        ...
        <div id="layoutSidenav_content">
            <main>
                <div className="container-fluid px-4">
                    ...
                    <div className="d-flex align-items-center py-2 mt-2 mb-2 border-bottom import-header-row">
                        {/* Left section: Breadcrumb + Search - chiếm 50% */}
                        <div className="import-left-section d-flex align-items-center gap-3">
                            ...
                            <div className="import-search-bar flex-grow-1">
                        ...
                        <div className="import-right-section d-flex align-items-center gap-2 justify-content-end">
