        ...
        <div id="layoutSidenav_content">
            <main>
                <div className="container-fluid px-4">
                    ...
                    <div className="d-flex align-items-center py-2 mt-2 mb-2 border-bottom supplier-header-row">
                        {/* Left section: Breadcrumb + Search - chiếm 50% */}
                        <div className="supplier-left-section d-flex align-items-center gap-3">
                            ...
                            <div className="supplier-search-bar flex-grow-1">
                        ...
                        <div className="supplier-right-section d-flex align-items-center gap-2 justify-content-end">
                            ...
                            <div className="supplier-action-dropdown">
                                <Dropdown>
                                    <Dropdown.Toggle 
