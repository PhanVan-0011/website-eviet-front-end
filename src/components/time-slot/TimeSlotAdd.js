    ...
    const handleSubmitForm = async (data) => {
        ...
        try {
            ...
            if (response.data && response.data.success) {
                toast.success(response.data.message || "Thêm khung giờ thành công!", toastSuccessConfig);
                
                navigation('/time-slot');
                
            } else {
                toast.error(response.data.message || "Thêm khung giờ thất bại", toastErrorConfig);
            }
        } catch (e) {
            dispatch(actions.controlLoading(false));
            ...
            <main>
                <div className="container-fluid px-4">
                    ...
                    <ol className="breadcrumb mb-4">
                        ...
                        <li className="breadcrumb-item active">Thêm khung giờ</li>
                    </ol>
